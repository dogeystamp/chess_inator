...
impl Board {
    ...
    pub fn set_piece(&mut self, sq: Square, pc: ColPiece, update_metrics: bool) -> Option<ColPiece> {
    ...
    pub fn set_square(&mut self, idx: Square, pc: Option<ColPiece>, update_metrics: bool) -> Option<ColPiece> {
        match pc {
